 ...
 */
@Service
public class OverallPlayerPublisherService {
    
    private final KafkaTemplate<String, String> kafkaTemplate;

    @Value("${player.topic.name:overall-players-topic}")
    private String topicName;

    
    @Autowired
    public OverallPlayerPublisherService(KafkaTemplate<String, String> kafkaTemplate) {
